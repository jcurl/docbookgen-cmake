...
# * DOCBOOK45_XSL_DIR: DocBook XSL (docbook-xsl-1.78.1)
...
function(ADD_DOCBOOK45_TARGET)
  ...
  # We only support HTML, until we get PDF working
  ...
  set(DOCBOOK45_XSL_DIR ${DOCBOOK45_XSL_DIR} CACHE STRING "Location of Docbook XSL 1.78.1")
  ...
  add_custom_target(
    ${target} ALL
    DEPENDS ${imagetargets} ${target}.stamp)
